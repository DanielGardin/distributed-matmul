#!/bin/bash
#SBATCH --job-name=matmul_serial_openblas
#SBATCH --time=02:00:00
#SBATCH --output=logs/openblas_run_%a.out
#SBATCH --error=logs/openblas_run_%a.err
#SBATCH --array=0-10
...
OUTPUT_FILE="results/blas/n${SIZE}_b1.csv"
